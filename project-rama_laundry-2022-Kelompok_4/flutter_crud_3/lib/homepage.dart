...
import 'package:flutter_crud_3/editdata.dart';
import 'package:flutter_crud_3/main.dart';
import 'package:flutter_crud_3/tambahdata.dart';
  ...
  Future _getdata() async {
    try {
      final respone = await http.get(
          Uri.parse('http://192.168.1.4/flutterapi/crudflutter/read.php'));
  ...
  Future _hapus(String id) async {
    try {
      final respone = await http.post(
          Uri.parse('http://192.168.1.4/flutterapi/crudflutter/hapus.php'),
          body: {
            "nisn": id,
          });
      if (respone.statusCode == 200) {
      ...
      return Scaffold(
        ...
        onPressed:() {Navigator.pushReplacement(context, 
                        MaterialPageRoute(builder: (context) {
                          return const MyHomePage(title: 'Back',);
                        }));
                      },
                      ),
                  ),
